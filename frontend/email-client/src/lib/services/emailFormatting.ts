 ...
 */
export function escapeHtmlContent(value: string | undefined | null): string {
 ...
 */
export function renderMarkdownContent(markdown: string | undefined | null): string {
 ...
 */
export function formatRelativeTimestamp(primary?: string, fallback?: string): string {
 ...
 */
export function formatFullTimestamp(primary?: string, fallback?: string): string {
  const date = parseDate(primary) || parseDate(fallback);
  if (!date) return escapeHtmlContent(fallback || '');
