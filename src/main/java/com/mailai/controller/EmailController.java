package com.composereai.controller;
...
public class EmailController {
     ...
     * This method should be adapted to use your actual EmailPipeline or EmailExtractor class.
     * 
    ...
    public ResponseEntity<Map<String, Object>> getApiInfo() {
        Map<String, Object> response = new HashMap<>();
        response.put("service", "MailAI Email Parser API");
        response.put("version", "1.0.0");
