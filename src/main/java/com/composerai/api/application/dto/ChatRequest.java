package com.composerai.api.application.dto;

import com.composerai.api.application.validation.AiCommandValid;
...
public class ChatRequest {
    ...
    // Optional legacy switch. Null means unspecified; explicit false means reasoning effort "none".
    private Boolean thinkingEnabled;

    // Optional: standard gateway thinking/reasoning effort
    private ReasoningEffortLevel thinkingLevel;
