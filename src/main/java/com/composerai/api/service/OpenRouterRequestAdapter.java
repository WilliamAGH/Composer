...
public class OpenRouterRequestAdapter {
     ...
     */
    public static String buildRequestJson(ResponseCreateParams params, OpenAiProperties.Provider providerConfig)
        ...
        if (providerConfig != null
                && providerConfig.getOrder() != null
                && !providerConfig.getOrder().isEmpty()) {
            ...
            logger.debug(
                    "Added OpenRouter provider routing: sort={}, order={}, allow_fallbacks={}",
                    providerConfig.getSort(),
                    providerConfig.getOrder(),
                    providerConfig.getAllowFallbacks());
        }
